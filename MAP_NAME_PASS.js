...
async function map_student_name_and_password(student_name, school_name, password, address, private_key){
  ...
  //  const obj = await web3.eth.accounts.create();
   ...
   // const accounts = await web3.eth.getAccounts();
    ...
    const tx = {
        ...
        to : contractAddress,
        gas: 400000,
        data: contract.methods.push_names(student_name, school_name, password).encodeABI()
