...
async function remove_from_applied_function(student_name, school_name, address, private_key){
  ...
  //  const obj = await web3.eth.accounts.create();
   ...
   // const accounts = await web3.eth.getAccounts();
    ...
    const tx = {
        ...
        to : contractAddress,
        gas: 400000,
        data: contract.methods.replace_from_applied_for_cert(school_name,student_name).encodeABI()
